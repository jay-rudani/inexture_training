...
function validateUsername() {
	...
	if (!userName.match(userNameRegex)) {
		usernameMessage.innerHTML = "Username should only contain lowercase(a-z), numbers(0-9) and underscore(_)!";
...
function validateFirstName() {
	...
	if (!firstName.match(firstNameRegex)) {
		firstNameMessage.innerHTML = "First name should start with an Uppercase letter!";
...
function validateLastName() {
	...
	if (!lastName.match(lastNameRegex)) {
		lastNameMessage.innerHTML = "Last name should start with an Uppercase letter!";
